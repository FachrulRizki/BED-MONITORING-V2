            ...
            <form action="{{ route('rooms.update', $room) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="male_capacity" name="male_capacity"
                           value="{{ old('male_capacity', $room->male_capacity) }}" min="0" required>
                    @error('male_capacity')
                        <p class="error">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="female_capacity" name="female_capacity"
                           value="{{ old('female_capacity', $room->female_capacity) }}" min="0" required>
                ...
                <div class="form-group">
                    <label for="male_occupied">Bed Laki-laki Terisi</label>
                    <input type="number" id="male_occupied" name="male_occupied"
                           value="{{ old('male_occupied', $room->male_occupied) }}" min="0">
                    @error('male_occupied')
                        <p class="error">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label for="female_occupied">Bed Perempuan Terisi</label>
                    <input type="number" id="female_occupied" name="female_occupied"
                           value="{{ old('female_occupied', $room->female_occupied) }}" min="0">
                    @error('female_occupied')
                        <p class="error">{{ $message }}</p>
                    @enderror
                </div>
